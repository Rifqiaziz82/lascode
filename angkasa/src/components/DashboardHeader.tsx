...
import { searchUsers } from "../lib/userService"; // 👈 import fungsi baru
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-red-500/20 text-slate-300 hover:text-red-300 transition-colors"
              title="Logout"
            >
